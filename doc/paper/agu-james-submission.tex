...
\begin{keypoints}
\item Using Penman-Monteith, a semi-empirical stomatal conductance
  model, and underlying water use efficiency, we develop a simplified
  analytical theory for when ecosystems will reduce or increase
  evapotranspiration in response to vapor pressure deficit perturbations.
\item The observed range of plant parameters result in a broad range
  of ecosystem response to increases in vapor pressure deficit, from
  strong reductions in evapotranspiration to strong increases in
  evapotranspiration depending on ecosystem type and environment.
\item The choice of stomatal conductance model fundamentally alters
  ...
  deficit, highlighting the need for further research on stomatal
  conductance and its representation in more sophisticated land
  surface models.
\end{keypoints}
