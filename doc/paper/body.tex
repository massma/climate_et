...
Given eddy-covariance FLUXNET2015 data (Sect. \ref{data}), every
term in our new version of PM (Eq. (\ref{et})) is observed, except
...
observations themselves. The variability of $\sigma$ then propagates
 any uncertainty through to our partial derivative of Eq.
...
With Eq. (\ref{d_et}) we have an analytical framework for ecosystem
...
Fig. \ref{idealized_sign}, specifically the trend back towards
