...
\begin{table}
  ...
  \begin{tabular}{l c c c}
    \hline
    Symbol & min (~15th percentile) & med (~50th percentile ) & max
                                                                (~15th
                                                                percentile)
    & citation
...
specific plant types and characteristics. Lastly, all code and data
used in this analysis, including those used to generate the figures
and tables, are publicly available at \url{https://github.com/massma/climate\_et}.
