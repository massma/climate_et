...
\begin{table}
  ...
  \begin{tabular}{l c c c}
    ...
    $g_{0}$  & leaf-scale mimimum stomatal conductance & m s$^{-1}$  & \citet{MEDLYN_2011} \\
...
% \end{linenomath*}
  ...
  constant with respect to changes in VPD \citep{Franks_2017,
  ...
  as environmental conditions including soil water content
