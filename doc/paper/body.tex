...
of \citet{Zhou_2015}, which were inspired optimal photosynthesis
theory, as a tool to approach this problem. \citet{Zhou_2015}, showed
...
% \end{linenomath*}
  ...
  temperature \citep{Lin_2015, Manzoni2013}. Exploring possible soil
  moisture (in)dependnce of the plant parameters (g$_1$ and uWUE) is
  particularly interesting because soil moisture only enters the
  partial derivative directly through these plant prameters. If the
  ...
  low soil moisture \citep{Zhou_2019}. Supplementary material for this
  ...
  research.
   ...
   Because Eq. (\ref{d_et}) is a partial derivative, it's utility is as a
   ...
   of Eq. (\ref{d_et}) should take care that their interpretation
