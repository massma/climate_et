...
In Term 1, $\frac{P}{T} \propto \rho$, so this should vary little relative to $g_a$ and $\Delta$.  $\gamma$ should also be relatively constant, So the scaling term, Term 1, should be primarily a function of $g_a$ and temperature (though the function $\Delta$). Figure \ref{scale_vary} shows how the magnitude of the scaling varies with $T$ and $g_a$. 
...
\caption{Variability of Term 1 for each PFT. Each colored line correspondes to a different aerodynamic resistance.}
\label{lai_vpd_fig}
\end{figure}
