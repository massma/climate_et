...
\item We remove days with rain and the day following to avoid issues with rain interception and sensor saturation and high relative humidity (\cite{MEDLYN2016).
\end{itemize}
...
Bottom: The location of the minima of ET, as a function of VPD and $\sigma$. Lines and stars denote the distribution of VPD and $\sigma$ next to each axis, following the same percentiles as above. \textbf{***need to replot with correct sigma (normalized to 1)***}}
\label{term3}
\end{figure}
