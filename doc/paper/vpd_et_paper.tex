...
\begin{abstract}
  ...
  increasing CO$_2$. While increased evapotranspiration (ET) in
...
of precipitation \citep[][]{Gentine_2013}. Furthermore, any increases
...
\citet{Medlyn_2017}'s method for calculating ecosystem scale $g_1$
using PM,
...
\citep{Zhou_2014, Zhou_2015} and
\citet{Medlyn_2017}'s stomatal conductance model is that
...
(PDSI) \citep{Swann_2016}. Lastly, all code and data used in this
