...
We use data from FLUXNET2015. Because $g_1$ coefficients \citep{Lin_2015} and uWUE were only both available for five plant functional types (PFTs - see Table 2),  only 56 of the 77 sites were used. Figure \ref{map} presents each site and its plant functional type.
...
\caption{Plant functional type and location of sites used in analysis.}
\label{map}
 \end{figure}
