...
\begin{frame}{Summary}
  ...
  \item For plants evolved to prioritize water conservation over production (low uWUE and $g_1$), atmospherc demand is less likely to dominate.
  ...
  \item Our form of Penman-Monteith is capable of estimating ET more realistically and could be used as a replacement for PET in drought indices (e.g. Palmer Drought Severity Index - PDSI).
  \end{itemize}
\end{frame}
