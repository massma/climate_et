...
\begin{equation}
  \lambda E = \frac{\Delta R + g_a \left( \rho_a c_p D_{s} - \frac{\gamma c_s \sqrt{D_s} P }{\text{LAI } R \; T \; 1.6 \text{ uWUE } (1 + \frac{g_1}{\sqrt{D_s}})} \right) }{ \Delta + \gamma}
\end{equation}
...
\begin{equation}
\frac{\partial \;  \lambda E}{\partial \; D_s} = \frac{g_a}{\Delta + \gamma}   \left( \rho_a c_p - \frac{\gamma c_s  P }{\text{LAI }1.6 \; R\; T \text{ uWUE }} \left( \frac{2 g_1 + \sqrt{D_s}}{2 (g_1 + \sqrt{D_s})^2}\right) \right)
\end{equation}
